...
namespace Scandimex
{
    public class WebReportRenderer : IDisposable
    {
        ...
        public byte[] RenderToBytesPDF()
        {
            ...
            string[] streams;
            Warning[] warnings;
            return reportInstance.Render("PDF", null, out mimeType, out encoding, out fileNameExtension, out streams, out warnings);
        }
        ...
        public byte[] RenderToBytesExcel()
        {
            ...
            string[] streams;
            Warning[] warnings;
            return reportInstance.Render("EXCEL", null, out mimeType, out encoding, out fileNameExtension, out streams, out warnings);
        }
